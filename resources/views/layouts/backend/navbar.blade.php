   ...
   <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('blog') }}" target="_blank" class="nav-link">View Site</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="/backend/img/user2-160x160.jpg" class="user-image img-circle elevation-2" alt="{{ $currentUser->name }}">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          @csrf
          <button class="btn btn-default btn-flat float-right">Sign
          Out</button>
        </form>
